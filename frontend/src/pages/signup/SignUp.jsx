    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 shadow-md bg-blue-0 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            <button
              className="btn btn-block btn-sm mt-2 border-none bg-slate-950 hover:bg-black text-gray-300 hover:shadow-[0_10px_50px_rgba(8,_112,_184,_0.7)] duration-300 ease-in"
              disabled={loading}
            >
              {loading ? (
